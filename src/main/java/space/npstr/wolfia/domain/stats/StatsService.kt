...
@Service
class StatsService internal constructor(
	...
	@EventListener
	fun onDataDelete(dataDelete: PersonalDataDelete) {
		anonymize(dataDelete.userId)
	}

	fun anonymize(userId: Long) {
		statsRepository.nullAllPlayerNicknamesofUser(userId)
	}
}
